...
class PaymentSearch extends AdminView {
  PaymentSearch({super.key});

  @override
  State<StatefulWidget> createState() => _PaymentSearch();
}

class _PaymentSearch extends AdminStateView<PaymentSearch> {
...
// Filter data based on the search term
        if (searchKeyword.isNotEmpty) {
          _paymentItems = _paymentItems.where((item) {
            return item['payment_method'].toLowerCase().contains(searchKeyword.toLowerCase());
          }).toList();
